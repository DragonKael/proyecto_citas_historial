...
public class Paciente {
	...
	/**
	* Default empty Paciente constructor
	*/
	public Paciente() {
        this.id = 0;
        this.codPersonal = "";
	...
	/**
	* Default Paciente constructor
	*/
	public Paciente(int id, String codPersonal, String nombre, String apPaterno, String apMaterno, String genero, String fechaNacimiento, String email, String direccion, String telefono, String imagen, String grupoSanguineo, String creadoEn, boolean favorito, boolean activo) {
		this.id = id;
	...
	*/
	...
	/**
	* Returns value of grupoSanguineo
	* @return
	*/
	...
	/**
	* Sets new value of grupoSanguineo
	* @param
	*/
